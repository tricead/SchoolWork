            ...
            this.addMouseListener(new MouseAdapter() {
                ...
                public void mousePressed(MouseEvent e) {
                    ...
                    if (available()) {
                        ...
                        while (nextDisc == 'R') {
                            int randoCounter = 0;
                            int randomx = generator.nextInt(randoCounter);
                            int randomy = generator.nextInt(randoCounter + 1);


                            if (cells[randomx][randomy].token == ' ') {

                                cells[randomx][randomy].repaint();
                                nextDisc = 'Y';
                            } else if (cells[randomx][randomy].token == 'R' || cells[randomx][randomy].token == 'Y') {
                                randoCounter++;
                            }
                        }
                    }
